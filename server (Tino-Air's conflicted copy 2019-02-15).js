...
const commands = {
  ...
  'anna': (msg) => {
    ...
    const products = ["rahat", "ES", "sytti", "hypersytti", "supersytti", "tulokone", "tulokone-x", "tulokiihdytin", "maski", "keppi", "es", "tuloimu"];
  ...
  'osta': (msg) => {
    ...
    if (purchase == "perustulo") {
      ...
      if (data[customer]["omistus"]["valaankasvatusohjelma"] == true) return msg.channel.send("Älä osta toista ohjelmaa, menee hukkaan!");
      if (money < 240000) return msg.channel.send("Lol, köyhä " + jaa);


      data[customer]["omistus"]["valaankasvatusohjelma"] = true;
